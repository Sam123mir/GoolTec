...
const WhatsAppButton = () => {
  const phoneNumber = '+51912345678'; // Replace with your actual WhatsApp number
  const message = 'Hola GoolTec, me gustaría obtener más información sobre sus productos.';
